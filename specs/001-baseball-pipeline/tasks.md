...
- [x] T003 [P] Create requirements.txt with pinned dependencies: pandas, sqlalchemy, pymysql, openpyxl, python-dotenv, pytest, pytest-cov
- [x] T004 [P] Create .env.example with DB_HOST, DB_PORT, DB_USER, DB_PASSWORD, DB_NAME, LOG_LEVEL placeholders
- [x] T005 [P] Add .env to .gitignore to prevent credential commits
- [x] T006 [P] Create data/ directory and add sample_batting_practice.xlsx fixture file
